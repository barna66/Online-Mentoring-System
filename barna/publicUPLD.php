...
<?php
	...
	$query5 = "SELECT File_name FROM uploads WHERE ID=$ID AND privacy='public'";
...
<li><a href="http://localhost:1234/publicUPLD.php?ID=<?php echo $ID; ?>&Name=<?php echo $name; ?>">Uploaded Files</a></li>
</ul>
<br>
</section>
<?php
	...
	{
		echo str_repeat('&nbsp;', 5).$upload."    <a href='download1.php?name=".$upload."'>download</a><br> ";
		$flag=1;
	}
	if($flag==0)
	{
		//str_repeat('&nbsp;', 5);
		echo str_repeat('&nbsp;', 5)."Nothing to show";
	}
?>
</body>
</html>
